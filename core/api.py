...
def get_leaderboard(request, period: str = 'all', difficulty: str = 'all', limit: int = 10):
    """
    ...
    # Sort and limit
    return list(queryset.order_by('-score')[:limit])
...
def get_user_streak(request):
    ...
    result = {
        ...
        "last_played": streak.last_played.isoformat() if streak.last_played else None,
        "today_played": False
    }
    ...
    if streak.last_played:
        ...
        result["today_played"] = streak.last_played.date() == date.today()
